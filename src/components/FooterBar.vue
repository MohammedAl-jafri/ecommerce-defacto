...
const onChangeCountry = () => {
  console.log('Country change clicked')
}
</script>
  ...
  <footer class="df-footer">
    ...
    <section class="df-main-footer">
      <div class="df-container df-main-row">
        ...
        <div class="col">
          <h4 class="col-title">
            <span class="col-title-text">DEFACTO</span>
          </h4>
          <ul>
            <li><a href="#">KURUMSAL</a></li>
            <li><a href="#">HAKKIMIZDA</a></li>
            <li><a href="#">İNSAN KAYNAKLARI</a></li>
            <li><a href="#">KURUMSAL SATIŞ</a></li>
            <li><a href="#">TOPTAN SATIŞ (WHOLESALE PARTNER)</a></li>
            <li><a href="#">DEFACTO TEKNOLOJİ</a></li>
        ...
        <div class="col">
          <h4 class="col-title">
            <span class="col-title-text">YARDIM</span>
          </h4>
<ul>
            ...
            <li>
              <a href="#" class="with-icon">
                <svg class="help-icon" width="20" height="11" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                   <circle cx="12" cy="12" r="11" stroke="#4b5563" stroke-width="1.5" fill="none"/>
                   <path d="M10 8l6 4-6 4V8z" fill="#4b5563"/>
                </svg>
                <span>SİPARİŞİMİ NASIL TAKİP EDERİM?</span>
              </a>
            </li>
            ...
            <li>
              <a href="#" class="with-icon">
                ...
                <span>NASIL İADE EDERİM?</span>
              </a>
            </li>
            <li><a href="#">GIFT CLUB SIKÇA SORULAN SORULAR</a></li>
            <li><a href="#">İŞLEM REHBERİ</a></li>
            <li><a href="#">KAMPANYALAR</a></li>
            <li><a href="#">KİŞİSEL VERİLERİN KORUNMASI VE GİZLİLİK</a></li>
          </ul>
        </div>
        ...
        <div class="col">
          <h4 class="col-title">
            <span class="col-title-text">BİZE ULAŞIN</span>
          </h4>
          <ul>
            <li><a href="#">MAĞAZALARIMIZ</a></li>
            <li><a href="#">İLETİŞİM FORMU</a></li>
          </ul>

          <div class="support-block">
            <div class="support-label">MÜŞTERİ HİZMETLERİ</div>
            <div class="support-phone special-click">0850 333 22 86</div>
          </div>
        </div>
        ...
        <div class="col col-social">
          <h4 class="col-title">
            <span class="col-title-text">TAKİP EDİN</span>
          </h4>
  ...
  <svg xmlns="http://www.w3.org/2000/svg"
    ...
    <path d="M15.574 0H8.426C6.192.003 4.049.891 2.47 2.47S.003 6.192 0 8.426v7.149c.003 2.234.891 4.376 2.47 5.955S6.192 23.997 8.426 24h7.149A8.433 8.433 0 0 0 24 15.575V8.426A8.44 8.44 0 0 0 15.574 0M12 17.586A5.58 5.58 0 0 1 6.413 12 5.58 5.58 0 0 1 12 6.413 5.58 5.58 0 0 1 17.586 12 5.6 5.6 0 0 1 12 17.586m7.164-10.912a1 1 0 0 1-.153.128 1 1 0 0 1-.179.092.8.8 0 0 1-.189.056 1 1 0 0 1-.199.02 1.1 1.1 0 0 1-.393-.077 1 1 0 0 1-.174-.092 1.3 1.3 0 0 1-.158-.128 1.04 1.04 0 0 1-.22-1.113 1 1 0 0 1 .092-.179 1 1 0 0 1 .128-.153 1.3 1.3 0 0 1 .158-.128 1 1 0 0 1 .174-.092 1.3 1.3 0 0 1 .194-.061 1.02 1.02 0 0 1 .919.281q.072.07.128.153c.056.083.07.116.097.179a1 1 0 0 1 .056.189 1.3 1.3 0 0 1 .02.199c.001.272-.107.534-.301.725zM12 7.945c-1.64 0-3.119.988-3.745 2.503s-.281 3.258.878 4.418 2.904 1.506 4.418.878S16.054 13.64 16.054 12A4.06 4.06 0 0 0 12 7.945m-.495 2.64A1.5 1.5 0 0 0 10.499 12a.766.766 0 0 1-1.532 0 3.03 3.03 0 0 1 2.032-2.86.765.765 0 0 1 .505 1.445z"/>
          ...
          <button class="country-btn" type="button">
            ...
            <span class="country-text" @click="onChangeCountry">
              ÜLKE DEĞİŞTİR
            </span>
          </button>
        </div>
      ...
      <div class="df-container df-copy-row">
        <p>
          © 2025 DEFACTO CLONE – (BSM WEB PROGRAMLAMA) – SHOPVUE
          / MOHAMMED AL-JAFRI / 210101088
        </p>
      </div>
    </section>
  </footer>
...
<style scoped>
/* SUPPORT SECTION (LOOKS LIKE A LINK) */
.special-click {
  font-size: 12px;
  color: #000000;
  cursor: pointer;
...
.special-click:hover,
.col .special-click:focus-visible {
  color: #848484;
}
...
/* أيقونة كرة أرضية */
.country-icon {
  background: url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 64 64' stroke='%231c1c1c' fill='none' stroke-width='3' stroke-linecap='round' stroke-linejoin='round'><circle cx='32' cy='32' r='28'/><path d='M22 6c3 6 3 8 0 12s-4 6-4 10 3 6 5 7 4 3 4 6-2 6-4 8'/><path d='M42 6c-2 4-2 8 1 11s5 4 7 7 1 8-1 11-6 5-8 6-3 3-3 6 1 5 2 7'/></svg>");
  width: 25px;
  height: 25px;
