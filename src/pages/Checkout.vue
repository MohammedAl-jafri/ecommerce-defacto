              ...
              <div class="checkout-box__content">
                <div class="address-grid">
                  ...
                  >
                    ...
                    <div class="addr-title">{{ addr.addressTitle || addr.district || 'ADRES' }}</div>
                    <div class="addr-text">
